...
private:
    ...
    chip::app::DataModel::Nullable<int16_t> mMinLevel;
    chip::app::DataModel::Nullable<int16_t> mMaxLevel;
    chip::app::DataModel::Nullable<int16_t> mCurrentLevel;
    chip::Optional<int16_t> mTargetLevel;
